...
<title>FastBite | {{ isset($product) ? 'Edit Product' : 'Create Product' }}</title>
                        ...
                        <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="name" required
                                    ...
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-orange-200 text-sm transition @error('name') border-red-400 @enderror">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="number" name="qty" required
                                    ...
                                    placeholder="0"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-orange-200 text-sm transition @error('qty') border-red-400 @enderror">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="price" required
                                        ...
                                        placeholder="0.00"
                                        class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-orange-200 text-sm transition @error('price') border-red-400 @enderror">
                                </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="cost" required
                                        ...
                                        placeholder="0.00"
                                        class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-orange-200 text-sm transition @error('cost') border-red-400 @enderror">
                                </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="category_id" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-orange-200 text-sm bg-white transition @error('category_id') border-red-400 @enderror">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="number" name="count" required
                                    ...
                                    placeholder="0"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-orange-200 text-sm transition @error('count') border-red-400 @enderror">
