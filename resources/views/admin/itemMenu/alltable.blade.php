                ...
                <div class="w-full overflow-x-auto rounded-xl border border-gray-100">
                    ...
                    <table class="w-full text-left text-sm sm:text-base">
                        ...
                        <thead class="bg-gray-50">
                            <tr class="border-b">
                                <th class="p-3">TableID</th>
                                <th class="p-3">Name</th>
                                <th class="p-3 hidden md:table-cell">Date</th>
                                <th class="p-3 hidden md:table-cell">Phone Number</th>
                                <th class="p-3 hidden lg:table-cell">Table</th>
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="p-3">0012</td>
                                <td class="p-3">Jonh Dee</td>
                                <td class="p-3">09-Dec-2025</td>
                                <td class="p-3">012-345-678</td>
                                <td class="p-3">2in1</td>
                                <td class="p-3">
