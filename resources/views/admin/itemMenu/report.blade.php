...
<div class="bg-[#FFE4DB] min-h-screen" x-data="{
    ...
    openExport(format) {
        const map = {
            excel: { label: 'Excel (.xlsx)', icon: 'chart', color: 'bg-emerald-600' },
            pdf:   { label: 'PDF document', icon: 'pdf',   color: 'bg-red-600'     },
            print: { label: 'Print preview', icon: 'print', color: 'bg-gray-900'   },
        };
    ...
    <div class="flex h-screen p-2 md:p-4 gap-4 md:gap-6 overflow-hidden relative">
        ...
        <main class="flex-1 overflow-y-auto pr-1 md:pr-2 custom-scrollbar">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-orange-100 p-6 md:p-8 mt-4 mb-8">
                ...
                <div class="flex gap-1 bg-gray-100 rounded-xl p-1 mb-6 no-print overflow-x-auto no-scrollbar">
                    @foreach(['reservations','orders','products','categories'] as $tab)
                    ...
                    <div class="w-full overflow-x-auto rounded-xl border border-gray-100">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-10 text-center text-gray-400 italic text-sm">No reservation data found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                @forelse($orders as $order)
                                    <tr class="hover:bg-orange-50/40 transition"
                                        ...
                                        <td class="px-4 py-3 font-medium text-gray-800">{{ $order->customer_name ?? 'Guest' }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-10 text-center text-gray-400 italic text-sm">No order data found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="w-full overflow-x-auto rounded-xl border border-gray-100">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="p-10 text-center text-gray-400 italic text-sm">No product data found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="w-full overflow-x-auto rounded-xl border border-gray-100">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-10 text-center text-gray-400 italic text-sm">No category data found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div id="printable-invoice" class="hidden">
            ...
            <table class="w-full text-left border-collapse mb-8">
                <thead>
                    <tr class="border-b-2 border-black">
                        <th class="py-2">ID</th><th class="py-2">Customer</th>
                ...
                <tbody>
                    @foreach($orders as $o)
                        <tr class="border-b">
                            ...
                            <td class="py-2">{{ $o->customer_name ?? 'Guest' }}</td>
