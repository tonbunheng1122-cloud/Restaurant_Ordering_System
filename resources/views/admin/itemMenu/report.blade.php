...
<div class="bg-[#FFE4DB] min-h-screen" x-data="{
    ...
    exportUrl(format) {
        return '/reports/export/' + format + '?type=' + this.activeTab;
    }
}">
                    ...
                    <div class="w-full overflow-x-auto rounded-xl border border-gray-100">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-10 text-center text-gray-400 italic">No reservation data</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="w-full overflow-x-auto rounded-xl border border-gray-100">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-10 text-center text-gray-400 italic">No order data</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                        ...
                        <table class="w-full text-left text-sm">
                            <thead class="bg-gray-50">
                                <tr class="border-b text-gray-600 uppercase text-xs">
                                    ...
                                    <th class="p-4 hidden lg:table-cell">Qty</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y">
                                @forelse($products as $product)
                                    <tr class="hover:bg-orange-50/50 transition"
                                        ...
                                        <td class="p-4 hidden lg:table-cell text-gray-600">{{ $product->qty ?? 'N/A' }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-10 text-center text-gray-400 italic">No product data</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="w-full overflow-x-auto rounded-xl border border-gray-100">
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="p-10 text-center text-gray-400 italic">No category data</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
